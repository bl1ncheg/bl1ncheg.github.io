...
function (t, e, i, n) {
        ...
        function P(t) {
                ...
                for (var i = 0, n = 0, s = 0; e > s;) i += t[s].clientX,
                n += t[s].clientY,
                s++;
                return {
                        x: vt(i / e),
        ...
        function H(t, e) {
                var i = T(t.touches),
                        n = this.targetIds;
                if (e & (Pt | Ot) && 1 === i.length) return n[i[0].identifier] = !0,
                [i, i];
        ...
        l(it, et, {
                ...
                directionTest: function (t) {
                        var e = this.options,
                                ...
                                r = t.deltaX,
                                o = t.deltaY;
                        return s & e.direction || (e.direction & qt ? (s = 0 === r ? zt : 0 > r ? Nt : Xt, i = r != this.pX, n = Math.abs(t.deltaX)) : (s = 0 === o ? zt : 0 > o ? Yt : kt, i = o != this.pY, n = Math.abs(t.deltaY))),
                        t.direction = s,
